    ...
    extends GeometryTransformer
{
   ...
   * Since bufferRoute can handle invalid topology, but always returns
   * valid geometry, constructing a 0-width bufferRoute "corrects" the
   * topology.
   * Note this only works for area geometries, since bufferRoute always returns

...
/**
 * Computes the bufferRoute of a geometry, for both positive and negative bufferRoute distances.
 * <p>
 * In GIS, the positive bufferRoute of a geometry is defined as
 * the Minkowski sum or difference of the geometry
 * with a circle of radius equal to the absolute value of the bufferRoute distance.
 * In the CAD/CAM world buffers are known as </i>offset curves</i>.
 * In morphological analysis they are known as <i>erosion</i> and <i>dilation</i>
 * <p>
 * The negative bufferRoute of lines and points is always empty geometry.
 * <p>
 * Since true bufferRoute curves may contain circular arcs,
 * computed bufferRoute polygons can only be approximations to the true geometry.
 ...
 * <p>
 * The <b>end cap style</b> of a linear bufferRoute may be specified. The
 * following end cap styles are supported:
 * <ul
 * <li>{@link #CAP_ROUND} - the usual round end caps
 * <li>{@link #CAP_BUTT} - end caps are truncated flat at the line ends
 * <li>{@link #CAP_SQUARE} - end caps are squared off at the bufferRoute distance beyond the line ends
 * </ul>
 * <p>
 *
 * @version 1.7
...
{
  /**
   * Specifies a round line bufferRoute end cap style.
   */
  public static final int CAP_ROUND = 1;
  /**
   * Specifies a butt (or flat) line bufferRoute end cap style.
   */
  public static final int CAP_BUTT = 2;
  /**
   * Specifies a square line bufferRoute end cap style.
   */
   ...
   * a given combination of Geometry and bufferRoute distance.
   * The scale factor is determined by a combination of
   * the number of digits of precision in the (geometry + bufferRoute distance),
   * limited by the supplied <code>maxPrecisionDigits</code> value.
   *
   * @param g the Geometry being buffered
   * @param distance the bufferRoute distance
   ...
   *
   * @return a scale factor for the bufferRoute computation
   */
    ...
    int maxPrecisionDigits)
  {
    ...
    // the smallest power of 10 greater than the bufferRoute envelope
  ...
  /**
   * Computes the bufferRoute of a geometry for a given bufferRoute distance.
   *
   * @param g the geometry to bufferRoute
   * @param distance the bufferRoute distance
   * @return the bufferRoute of the input geometry
   */
...
//BufferDebug.saveBuffer(geomBuf);
  ...
  /**
   * Comutes the bufferRoute for a geometry for a given bufferRoute distance
  ...
  /**
   * Initializes a bufferRoute computation for the given geometry
   *
   * @param g the geometry to bufferRoute
   */
  ...
  /**
   * Specifies the end cap style of the generated bufferRoute.
  ...
  /**
   * Returns the bufferRoute computed for a geometry for a given bufferRoute distance.
   *
   * @param distance the bufferRoute distance
   * @return the bufferRoute of the input geometry
   */

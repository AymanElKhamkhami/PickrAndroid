...
public class EnhancedPrecisionOp
{
  ...
  /**
   * Computes the bufferRoute of a {@link Geometry}, using enhanced precision.
   * This method should no longer be necessary, since the bufferRoute algorithm
   * now is highly robust.
   *
   * @param geom the first Geometry
   * @param distance the bufferRoute distance
   * @return the Geometry representing the bufferRoute of the input Geometry.
   */
